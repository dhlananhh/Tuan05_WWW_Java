                    ...
                    <c:forEach items="${ DanhSachDienThoai }" var="dienThoai">
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="${pageContext.request.contextPath}/QuanLyForm?action=delete&id=<c:out value='${ dienThoai.maDienThoai }' />" class="btn btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
